        ...
        <div className="custom-container relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-6xl font-black text-primary mb-6 tracking-tight">
              ...
              <span className="text-secondary opacity-90 italic">
                Infrastructure
              </span>
            </h2>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            >
              <div className="relative">
                ...
                <div className="space-y-6 text-secondary text-lg leading-relaxed">
                  <p>
                    I am a passionate Civil Engineering graduate from{" "}
                    <span className="text-primary font-bold">
                      Pokhara University
                    </span>
                    , recognized as a top-performing scholar with a commitment
                    to technical precision and structural innovation.
                  </p>
                  <p>
                    My work bridges the gap between traditional engineering
                    principles and modern concrete technology. As a published
                    author, I dedicate my expertise to simplifying complex
                    concepts for the next generation of engineers while pursuing
                    rigorous research in infrastructure resilience.
                  </p>
                </div>
                ...
                <div className="mt-12 flex flex-wrap gap-8 items-center">
                  <div className="flex items-center gap-3 py-3 px-6 bg-surface border border-secondary/10 rounded-2xl shadow-sm">
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-secondary/40 uppercase tracking-widest leading-none mb-1">
                        Based In
                      </p>
            ...
            >
              <div className="relative p-10 bg-primary rounded-[2.5rem] shadow-2xl overflow-hidden group">
                ...
                <h4 className="text-white text-2xl font-bold mb-6 relative z-10">
                  High Impact Core
                </h4>
                ...
                <div className="space-y-8 relative z-10">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm">
                        Consistent 4.0 SGPA candidate at Pokhara University.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm">
                        EU Erasmus+ B+NeSDG Program active representative.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="p-8 bg-surface border border-secondary/10 rounded-3xl hover:-translate-y-2 transition-transform duration-500">
                  ...
                  <p className="text-primary font-bold text-lg leading-tight mb-2">
                    Structural Analysis
                  </p>
                  <p className="text-secondary/60 text-xs">
                    Modern modeling & design specialized.
                  </p>
                </div>
                <div className="p-8 bg-surface border border-secondary/10 rounded-3xl hover:-translate-y-2 transition-transform duration-500">
                  ...
                  <p className="text-secondary/60 text-xs">
                    Engineering textbooks & research items.
                  </p>
                </div>
              </div>
            </motion.div>
